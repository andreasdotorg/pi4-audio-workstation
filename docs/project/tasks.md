...
| TK-035 | Install qt6-wayland for native Wayland rendering | unassigned | open | US-006 | owner VNC testing session (2026-03-09) | Mixxx (Qt6) runs via XWayland because qt6-wayland plugin is missing. Package: `qt6-wayland` (6.8.2-4 in Trixie repos). May also fix broken icons (TK-036). |
| TK-036 | Fix missing icons in Mixxx | unassigned | open | US-006 | owner VNC testing session (2026-03-09) | Mixxx shows broken/missing icons on headless virtual display. Likely needs an icon theme (`adwaita-icon-theme` or similar). May be resolved by TK-035 (qt6-wayland). |
...
| TK-038 | Configure fullscreen launch for Mixxx and Reaper | unassigned | open | standalone | owner VNC testing session (2026-03-09) | Apps launch in windowed mode on the virtual display. Owner wants fullscreen by default. Options: labwc window rules in `rc.xml`, or launch scripts with fullscreen flags. |
| TK-039 | End-to-end audio validation via VNC | unassigned | blocked | US-029/US-030 | owner VNC testing session (2026-03-09) | Neither Mixxx nor Reaper has confirmed audio output yet. TK-015/TK-016 cannot be FULL PASS until audio is verified. Blocked on: TK-037 (Reaper audio), possibly TK-035 (Mixxx audio path). |
...
- Tasks TK-001 through TK-039 are active (done in place: TK-001, TK-002, TK-004, TK-012, TK-013, TK-015 (PARTIAL -- audio pending TK-039), TK-016, TK-023 (FAIL), TK-024, TK-025, TK-026, TK-027, TK-028, TK-029, TK-030, TK-031, TK-033, TK-034). TK-005 in-progress (pending Pi validation). TK-100+ are completed (numbering gap is intentional for clarity).
