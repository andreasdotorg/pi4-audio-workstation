...
| US-052 | IMPLEMENT | 1/6 | 5/12 subtasks done (SG-1 `ecad1d6`, SG-2 `981b824`, SG-3 `a10bd95`, SG-4 `5bfab1b`, SG-9 `9cd316f`). SG-5 ready (unblocked by SG-4). SG-6 blocked on SG-5 only. SG-7-12 blocked. (1) Design doc: DONE. (2) Binary on Pi: not yet. (3) Integration test: not yet. (4) RT safety audit: not yet. (5) 5-min stability: not yet. (6) Lab note: not yet. |
...
- **US-052** (Phase: **IMPLEMENT** — 5/12 subtasks done): Real-time signal generator in Rust. D-037 APPROVED (TK-234 DONE). **SG-1 through SG-12 filed.** SG-1 DONE (`ecad1d6`), SG-2 DONE (`981b824`), SG-3 DONE (`a10bd95`), SG-4 DONE (`5bfab1b`), SG-9 DONE (`9cd316f`). SG-5 ready (unblocked by SG-4, next on critical path). SG-6 blocked on SG-5 only (convergence point nearly reached). Critical path: ~~SG-1->SG-4->~~ SG-5->SG-6->SG-7->SG-8->SG-10->SG-11->SG-12. TK-151 nix build in progress (gates Pi integration tests). Supersedes TK-229. Blocks US-053, US-047, US-012.
