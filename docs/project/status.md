...
- **TK-225/226** (ready, promoted to essential): Persistent status bar + mini 24-channel meters across all views. Owner promoted from deferred backlog. No dependencies — can start immediately.
