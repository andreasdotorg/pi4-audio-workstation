...
**New defects filed:** F-096 (flaky measurement wizard test), F-097 (signal-gen mono — AE endorsed, US-052 amendment scoped). F-085 expanded to 10 items with owner graph feedback.
