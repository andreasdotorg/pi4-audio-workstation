## F-037: Web UI on port 8080 has no authentication (CONVERTED)

**Severity:** High
**Status:** Converted to US-110 (2026-03-29)
...
**Scoping complete (2026-03-29):** All advisors aligned on passkey auth design.
Ready for story creation and implementation when prioritized by owner.
...
1. Add authentication to the web UI. Options (in order of preference for this
   ...
   d. **Passkey auth (recommended)** — all advisors aligned on this design
      (2026-03-29). Implementation ready when prioritized.
